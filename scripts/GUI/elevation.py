...
class MapViewer(QWidget):
	...
	def __init__(self, *args, **kwargs):
        ...
        # takes in the points that are generated by Luhan's code
        # coordinates as key and elevation as item 

        '''basically need to find where all of the coords of the maps are stored, use 
        them as the key to get info from the JSON file. Depending on the range then assign that coord a colour.
        Then apply some filter/colour block/coloured point on the map to indicate elevation
        '''

...
# =======================
BASE_DIR = "/rover_ws/src/comp_data/rsx-rover/updated_data"       # Folder containing test, train, val
LABELS_DIR = "/rover_ws/src/comp_data/rsx-rover/Labels"           # Folder containing label files

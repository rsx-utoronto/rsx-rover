...
speed_limit = [100, 100, 100, 100, 100, 100, 100]                    # Gear Ratio for the 550s is 1x100
t = 0
...
def MapJoystick(joy_input, current_pos, speed_limit, dt):   #takes in the joystick input(I), the current position of the motors (O), the speed limits (S)
    ...
    current_pos[0] = SetJointSpeed(joy_input[5], current_pos[0], speed_limit[0], dt)
    ...
    current_pos[5] = SetJointSpeed(joy_input[0], current_pos[5], speed_limit[5], dt)

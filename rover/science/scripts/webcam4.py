...
# camera_name = "Sunplus Innovation Technology Inc. FHD Camera"
# camera_id = getmicroscopeid.get_usb_camera_device(camera_name)
camera_id = "/dev/video14"
...
class WebcamNode(Node):
    def __init__(self):
        ...
        self.pub_compressed = self.create_publisher(CompressedImage, "/webcam4/compressed", 1)
        self.pub_raw = self.create_publisher(Image, "/webcam4", 1)

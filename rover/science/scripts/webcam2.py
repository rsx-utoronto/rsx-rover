...
class WebcamNode(Node):
    def __init__(self):
        ...
        self.pub_compressed = self.create_publisher(CompressedImage, "/webcam2/compressed", 1)
        self.pub_raw = self.create_publisher(Image, "/webcam2", 1)

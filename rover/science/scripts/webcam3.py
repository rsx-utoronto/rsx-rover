...
class WebcamNode(Node):
    def __init__(self):
        ...
        self.pub_compressed = self.create_publisher(CompressedImage, "/webcam3/compressed", 1)
        self.pub_raw = self.create_publisher(Image, "/webcam3", 1)

...
class ImuDataToENU:
    def __init__(self):
        ...
        self.sub = rospy.Subscriber('/camera/imu', Imu, self.imu_callback)
    ...
    def imu_callback(self, data):
        ...
        transformed.angular_velocity.x = data.angular_velocity.x
        transformed.angular_velocity.y = data.angular_velocity.z
        transformed.angular_velocity.z = -data.angular_velocity.y

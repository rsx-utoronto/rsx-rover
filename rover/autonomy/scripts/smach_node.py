...
class StateMachineNode():
    ...
    def __init__(self):
        ...
        self.autonomy_srv = rospy.Service('rover/launch', Empty, self.launch_callback)
        self.STATE = "IDLE"
        self.GPS_GOALS = np.zero
    ...
    def launch_callback(self, request):
        self.handle_launch()
        return EmptyResponse()
    
    def handle_launch(self):
        self.STATE = "INITIALIZE"
        print('Autonomy task start detected.')
...
def main():
    ...
    with sm:
        ...
        smach.StateMachine.add('RoverIdle', RoverIdle(),
        ...
        smach.StateMachine.add('RoverStart', RoverStart(), 
                               transitions={'GPS_GOAL_QUEUED':'RoverGPSTraverse'})
        smach.StateMachine.add('RoverGPSTraverse', RoverGPSTraverse(), 
                               transitions={'GPS_GOAL_REACHED':'RoverARucoTraverse'})
        smach.StateMachine.add('RoverGPSCheckpoint', RoverGPSCheckpoint())
        smach.StateMachine.add('RoverARucoTraverse', RoverARucoTraverse(),

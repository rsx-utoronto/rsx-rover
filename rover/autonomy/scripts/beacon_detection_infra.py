...
class image_converter:
    ...
    def __init__(self):
        ...
        self.info_sub = rospy.Subscriber("/camera/infra2/camera_info", CameraInfo, self.get_coordinates)        
        self.image_sub = rospy.Subscriber("/camera/infra2/image_rect_raw", Image, self.brightest_spot)

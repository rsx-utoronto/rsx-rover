...
class ObjectDetectionNode(Node):
    def __init__(self):
        ...
        self.curr_state = "Start" #TODO: change this to Start when actually running the mission, not on node init
        t = time.time()
        # while (time.time() - t) < 2:
        #     #print("Passing time") 
        #     pass
        ...
        self.state_sub = self.create_subscription(String, self.state_topic, self.state_callback, STATE_QOS)
        ...
        self.conf = 0.4  # Set confidence threshold
    ...
    def mission_state_callback(self, msg):
        ...
        if self.mission_state_msg == "START_GS_TRAV":
            if getattr(self, 'last_cv_image') is not None:
                ...
                self.get_logger().info("ar_detection_node: No image received yet for object detection.")
    ...
    def detect_objects(self, img):
        ...
        for result in results:
            ...
            for box in detections:
                ...
                print(f"Detected {obj_name} with confidence {conf:.2f} at [{x1}, {y1}, {x2}, {y2}]")
